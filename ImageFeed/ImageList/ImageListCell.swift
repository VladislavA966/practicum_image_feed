...
final class ImageListCell: UITableViewCell {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            dateLabel.bottomAnchor.constraint(equalTo: gradientView.bottomAnchor),
            dateLabel.leadingAnchor.constraint(equalTo: gradientView.leadingAnchor, constant: 8),
            dateLabel.trailingAnchor.constraint(lessThanOrEqualTo: gradientView.trailingAnchor, constant: -20),
    ...
    private func setupGradientLayer() {
        let baseColor = UIColor(red: 26/255, green: 27/255, blue: 34/255, alpha: 1.0)
